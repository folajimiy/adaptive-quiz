...
# Uncomment if needed in a fresh Colab environment:
# !pip install python-pptx openai anthropic
...
QUESTIONS_PER_CELL = 50  # questions per (topic, subtopic, Bloom level)
